  ...
  const educationData = [
    {
      ...
      school: "C.T.M High School",
      mascot: "📘",
      achievements: ["GPA: 4.08", "Subject: Humanities"],
    },
    {
      degree: "Higher Secondary Certificate (HSC)",
      school: "Barhatta Govt College",
      mascot: "📗",
      achievements: ["GPA: 3.50", "Subject: Humanities"],
    },
  ];
  return (
    <section id="education" className="section flex flex-col py-40">
